...
Training at the intersection of biostatistics, epidemiology, and geoinformatics, I have specialized myself in the
...
studies. Capitalizing on these advanced exposure assessment methods has allowed
me to lead research on the effects of the built environment on many different
types of pediatric health outcomes. Furthermore, I have developed a novel approach and
...
disparate and heterogeneous geomarkers via spatiotemporal location will reduce
the need for manual data curation and specialized expertise currently required
to utilize them within biomedical research studies.

In this project, I will serve as the Principal Investigator and will utilize my
expertise and experience in geoinformatics and geomarker assessment methods and
tools to accomplish and supervise all aspects of the proposal. I am personally
excited to accomplish these research goals because democratizing geomarker assessment tools has the potential
to accelerate biomedical discoveries in many domains. Furthermore, contributing
a free and open source tool and facilitating its adoption and sustainability
will likely have a large impact on science in general.\\
...
\begin{enumerate}
  ...
  \textit{Pediatrics}. 2019.
	...
	\item Andrew F. Beck, Carley L. Riley, Stuart Taylor, \textbf{Cole Brokamp}, Robert S. Kahn. Toward a Culture of Health in Hospitals: Pervasive population disparities in inpatient bed-day rates across conditions and subspecialties. \textit{Health Affairs}. 37(4). 551-559. 2018.
		
	\item Lauren C. Riney, \textbf{Cole Brokamp}, Andrew F. Beck, Wendy Pomerantz, Hamilton Schwartz, Todd A. Florin. Emergency Medical Services Utilization is Associated with Community Deprivation in Children. \textit{Prehospital Emergency Care}. Online ahead of print. 2018.

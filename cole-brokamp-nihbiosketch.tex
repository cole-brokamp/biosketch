...
advance precision public health. The goal of this PORA application is to develop
and test an app-enhanced intervention to perform real-time prediction of FIES
events in CF patients. My work already includes collaborations with Dr.
Szczesniak to develop an app for prediction of rapid decline in
...
characteristics, known as “geomarkers”, that are predictive of rapid decline. My overarching research has focused on using GIS, machine learning, and causal inference methods with “big
spatial data” to estimate the effect of spatiotemporal environmental exposures
...
problems and inform targeted interventions. The work proposed in this project is
directly related to my line of research with Dr. Szczesniak and will allow us to
take a critical next step towards transforming CF care in this new age of
telehealth. I currently lead the Geospatial Research Accelerator for Precision Public Health
(GRAPPH) Core, which collaborates with several physician-scientists to create
interactive web and personal applications designed to be used by patients and
care providers. For this proposal, I will oversee and work alongside GRAPPH
personnel to design, develop, and test the proposed application. The success of this research is expected based on preliminary studies that I

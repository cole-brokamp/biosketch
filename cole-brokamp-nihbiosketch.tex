...
As a biostatistician and geoinformatician, I have specialized myself in the areas of machine learning and its application to large environmental and clinical datasets. Recent democratization of “big spatial data” and advances in geoinformatics have allowed unprecedented access to environmental and socioeconomic characteristics that vary highly with respect to both time and space. More precise environmental features require more complex modeling and I have dedicated my early career to furthering exposure science methodology in order to bring more precise exposure assessment tools to environmental health studies. Furthermore, I have previously developed a novel approach and accompanying software package called DeGAUSS which allows for user-friendly attachment of geospatial variables to existing research cohorts. I have previously worked with the other co-investigators and the Principal Investigator of the proposed study, Dr. Beck, through our Community Health Initiative at Cincinnati Children’s and our Geospatial Research Accelerator for Precision Population Health (GRAPPH). I’m excited to offer my expertise to help develop the RISEUP system. My experience and skills in geospatial analyses and programming and data integration will help provide the project with critical infrastructure. As a pediatric researcher who also investigates the effects of community characteristics and environmental exposure on childhood health, I am committed to completing the proposed work with this interdisciplinary team. Furthermore, my experience in implementing near real-time interactive data visualization applications for point-of-care use by patients, their families, and their physicians will contribute greatly to the success of this project. In short, I am excited to serve as statistical lead for this innovative project. Some of my key publications include:

...
I look forward to collaborating with Drs. Mizukawa and Laurynenka, as well
as the other co-investigators in order to establish a case-control matching
procedure that will incorporate geomarkers, but keep private health information
shielded from the investigators, in order to increase statistical power and make
the control selection process more efficient and secure. \\

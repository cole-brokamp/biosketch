...
intersection of biostatistics, epidemiol¬ogy, and geoinformatics in order to
advance precision public health. This project focuses on development of a single
set of pediatric home-based quality domains integrating newly-identified,
patient-prioritized, perspectives with those from clinicians and parents and to
prototype a decision-support tool. My work includes collaborations with Drs.
Szczesniak and Grossoehme to develop an app for prediction of rapid decline in
children with cystic fibrosis, and my latest R01-funded efforts include
expanding this app to include environmental exposures and community
characteristics, known as “geomarkers”, that are predictive of rapid decline. In
addition, my socioeconomic deprivation measures that I have studied in urban
populations formed the basis of the rationale to examine these markers in the
pediatric hospice and palliative care population. My overarching research has
focused on using GIS, machine learning, and causal inference methods with “big
spatial data” to estimate the effect of spatiotemporal environ-mental exposures
on neurobehavioral and psychiatric pediatric health outcomes. Specifically, my
interest lies in the interaction of these urban exposures with individual- and
community -level socioeconomic characteristics in order to identify
subpopulations of children who are more susceptible to environmental health
problems and inform targeted interventions. The work proposed in this project,
specifically in the third aim, is directly related to my line of research. It
offers an extension to not only build a platform for next-generation home-based
pediatric hospice and palliative care (HBHPC), but to also identify novel
socioeconomic risk factors in a population in which integrated domains and
digital platforms for care are urgently needed. I lead the Geospatial Research
Accelerator for Precision Public Health (GRAPPH) Core and will oversee efforts
made by my personnel for this proposal for geoinformatics and app development.
The success this research is expected based on preliminary studies that I
discussed with the PIs and the continuum it represents in a strong line of
computational medicine research, on which I am already a key contributor.\\

...
As a biostatistician and geoinformatician, I have dedicated my early career to conducting interdisciplinary and collaborative research around the place-based determinants of health.  Recent democratization of “big spatial data” and advances in geoinformatics have allowed unprecedented access to environmental and socioeconomic characteristics that can be linked to individuals, their families, and care providers. My experience in creating interactive applications that display health and spatial information will be a valuable resource for our team as we work towards making information on community health resources and neighborhood-level health disparities more findable, accessible, and understandable to all. I look forwarding to working as a part of this team in order to utilize community stakeholder feedback into our iterative design process for a health information resource to improve population health.\\

...
My research background, expertise, and mentorship experience will allow me to serve as a preceptor for this training grant. As a biostatistician and environmental epidemiologist, I have specialized myself in the areas of machine learning and its application to large environmental and clinical datasets.  Recent democratization of “big spatial data” and advances in geoinformatics have allowed unprecedented access to environmental and socioeconomic characteristics that can be used to estimate spatiotemporal community characteristics and pollutant exposures with great precision and accuracy. My research has been supported by awards from the NIH, Academy Health, Ohio Department of Medicaid, Robert Wood Johnson Foundation, and the Clinical Translational Science Awards (CTSA) Program.

I have mentored several trainees, helping them work with large datasets from the electronic health record and other extant databases, such as spatiotemporal air pollution, census-derived community characteristics, and satellite-based greenspace assessment.  My statistical expertise in ``case-only'' study designs have allowed for clinical trainees to gain experience in case-crossover and time-series study design and analysis.  To date, I have mentored or am currently mentoring three clinical fellows, four PhD students, and three MS students that have resulted in multiple publications, including:
...
\begin{enumerate}
	...
	\item Todd A. Florin, \textbf{Cole Brokamp}, Rachel Mantyla, Bradley DePaoli, Richard Ruddy, Samir S. Shah, Lilliam Ambroggio. Validation of the IDSA/PIDS Severity Criteria in Children with Community-Acquired Pneumonia. Clinical Infectious Diseases. ciy031. 1-29. 2018. 

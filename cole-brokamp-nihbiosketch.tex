...
Our group has recently have created a satellite-based land use random forest model
that produces daily estimates of fine particulate matter from 2000 through 2015 at a
resolution of 1 x 1 km across the Greater Cincinnati area.  I will complete the
extension of this model to 2020 throughout the entire United States. I have
recently collaborated with Drs. Ryan and Welge to complete the first study of
the psychiatric effects of short term air pollution in children and this work
represents the next step of my research program. In general, I have experience and expertise in working with large electronic
health record databases to study the health effects of environmental exposures,
especially using case-crossover study designs. In this project, I will work with the
PEDSnet learning network, the study staff and co-investigators to
oversee all aspects of the research project, ensure the scientific integrity of
the proposed study, and ensure its successful completion.\\

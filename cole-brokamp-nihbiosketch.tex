...
socioeconomic characteristics that can be linked to individuals, their families,
and care providers. I have created a decentralized approach and accompanying
software implementation that facilitates geocoding and attachment of geomarkers
to participants in multi-site studies without requiring the sharing of private
health information (PHI) over the internet with any third party or coordinating
center. I have applied this software to several NIH-funded multi-site studies in
order to augment research data with environmental and socioeconomic geomarkers
and I will work to do the same within the proposed project. Consultation on the
addition of geomarkers to existing and newly collected health data will enhance
the research productivity of investigators within the research community.  If
needed, I will work to customize these resources to meet the needs of
researchers. I look forward to making myself available and contributing to the
PORTICO CCCR Methods Core by promoting clinical research and training in PMSKD
by developing, applying, and disseminating advanced geoinformatics methods.\\
...
LeMasters, Cole Brokamp. Residential Greenspace Is Associated with Childhood

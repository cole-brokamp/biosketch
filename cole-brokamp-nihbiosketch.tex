...
I'm excited to offer my expertise to our project by overseeing the assessment of environmental exposures and community characteristics that are hypothesized to be linked to antibiotic resistance. Using highly precise measures to study individual-level antibiotic resistance will highlight the importance of using all available information -- not just that which is measured in the clinical care setting.  In addition, collaborating with an interdisciplinary team to work towards utilizing these findings in a clinical setting will be especially novel.  I have previously worked with Dr. Ambroggio and other co-Investigators on this proposal to analyze electronic health record data linked with biomarker-based diagnostic tests, and I look forward to further cultivating our interdisciplinary collaboration. 
...
\begin{enumerate}
	...
	\item Todd Florin, Lilliam Ambroggio, \textbf{Cole Brokamp}, Mantosh S. Rattan, Eric J. Crotty, Andrea Kachelmeyer, Richard M. Ruddy, Samir Shah. Reliability of Examination Findings in Suspected Community-Acquired Pneumonia. \textit{Pediatrics}. 140(3). e20170310. 2017. Download.
	
	\item Todd Florin, \textbf{Cole Brokamp}, Rachel Mantyla, Bradley DePaoli, Richard Ruddy, Samir Shah, Lilliam Ambroggio. Validation of the IDSA/PIDS Severity Criteria in Children with Community-Acquired Pneumonia. \textit{Clinical Infectious Diseases}. ciy031. 1-29. 2018. 
...
\begin{datetbl}
2010--2016  & Graduate Research Assistant, University of Cincinnati Department of Environmental Health\\
...
\begin{enumerate}
	...
	\item \textbf{Cole Brokamp}, Roman Jandarov, Monir Hossain, Patrick Ryan. Predicting Daily Urban Fine Particulate Matter Concentrations Using Random Forest. \textit{Environmental Science \& Technology}. Online ahead of print. 2018.
...
\begin{enumerate}
	...
	\item \textbf{Cole Brokamp}, MB Rao, Tina Zhihua Fan, Patrick H Ryan. Does the elemental composition of indoor and outdoor PM2.5 accurately represent the elemental composition of personal PM2.5? \textit{Atmospheric Environment}. 101. 226-234. 2015.
	
	\item \textbf{Cole Brokamp}, Grace LeMasters, Patrick Ryan. Residential mobility impacts exposure assessment and community socioeconomic characteristics in longitudinal epidemiology studies. \textit{Journal of Exposure Science and Environmental Epidemiology}. 26(4). 428-34. 2016. 
...
\begin{enumerate}
	...
	\item Jennifer Kannan, \textbf{Cole Brokamp}, David I. Bernstein, Grace K. LeMasters, Gurjit K. Khurana Hershey, Manuel Villareal, James E. Lockey, Patrick Ryan. Parental Snoring and Environmental Pollutants, but Not Aeroallergen Sensitization, Are Associated with Childhood Snoring in a Birth Cohort. \textit{Pediatric Allergy, Immunology, and Pulmonology}. 0. 2016.
	
	\item Andrew F. Beck, Carley L. Riley, Stuart Taylor, \textbf{Cole Brokamp}, Robert S. Kahn. Toward a Culture of Health in Hospitals: Pervasive population disparities in inpatient bed-day rates across conditions and subspecialties. \textit{Health Affairs}. 2018. \emph{In Press}.

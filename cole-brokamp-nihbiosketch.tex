...
sewer overflows, greenspace, poverty, cultural isolation) on pediatric
psychiatric and neurobehavioral health
...
As a part of my work, I have gained experience and expertise in creating
interactive web applications that are designed to communicate data and model
summaries as well as risk assessments to clinicians, patients, and policy makers
within the fields of cystic fibrosis (CF), personal air pollution monitoring,
neighborhood-based determinants of health, and gestational opioid exposures (colebrokamp.com/shiny).
Specifically within CF, I have previously collaborated with Dr. Szczesniak on an
interactive web application for communicating predictions from her novel
statistical model that predicts rapid decline in lung function.  I look forward
to continuing our collaboration by completing the addition of marker data
identified by Dr. Ziady to the app interface and field testing its usage by
clinicians within the CF learning network. This timely and impactful work will
represent the first lung function decline prognosis test and I am excited to

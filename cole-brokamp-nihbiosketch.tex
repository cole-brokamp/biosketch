...
I have previously collaborated with Drs. Brunst and Ryan within the CCAAPS
cohort, specifically studying the impact of neighborhood greenspace on anxiety,
depression, and neurobehavioral outcomes. Furthermore, I have utilized decision
trees and random forest machine learning models within exposure assessment and
health association models.

In this project, I will serve as co-investigator and will utilize my training
and expertise in statistical modeling and machine learning to work with Dr.
Brunst in order to explore whether or not exposure to fluoride impacts
internalizing outcomes by altering mitochondrial and/or brain structure and
function. I look forward to contributing to this important, timely, and
impactful research proposal.\\
